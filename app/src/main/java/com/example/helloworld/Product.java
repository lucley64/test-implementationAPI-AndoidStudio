...
public class Product {
     ...
     */
    public Product(String json) throws IOException, Resources.NotFoundException {
     ...
     */
    public static Product getProductFromBarCode(String barCode) throws IOException, Resources.NotFoundException, CancellationException, ExecutionException, InterruptedException {
        return new Product(new OpenFoodFactsAPI().execute("https://fr.openfoodfacts.org/api/v0/product/" + barCode + ".json").get());
    }
}
